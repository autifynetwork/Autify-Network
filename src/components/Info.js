    ...
    return (
        <>
              ...
              <div className="container"  id="problem">
               ...
               <h5 style={{color:"white",fontWeight:"lighter"}}><span style={{color: "#a25edc",fontWeight: "normal"}}> A revolution for every industry</span></h5>
               <h1 className="py-3 mx-auto" id="h22" style={{marginTop:"2%",color:"white",WebkitBackgroundClip: "text",backgroundClip: "text"}}>
               The Future of the Counterfeit Battle</h1><h6 style={{color:"white",fontWeight:"lighter"}} className="mr-3">
                   <span style={{color: "white",fontWeight: "normal"}}>Counterfeit products have long threatened the global market with low-quality copies. These fake goods often effectively put the brand’s reputation and business at peril. In a number of cases, such goods can prove downright dangerous and we are committed to combating this criminal enterprise. Every industry can benefit from our innovative combination of image recognition and blockchain technology.</span></h6>
                   <div className="my-5"><a  className="button_info my-3" href="#contact" data-target="#contact">Get in Touch</a></div>
               </div>
                    ...
                    <div className="row flex-row flex-nowrap overflow-auto x-scroll-disabled">
                        <div className="col mx-auto my-auto" >
                            <div className="row mb-lg-5 mx-auto" id="ok">
                                <div className="row">
                                <img src={img1} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
                                    Poor Quality Product Market
                                    </h4>
                                </div>
                            </div>
                            <div className="row my-lg-3 my-xs-0 my-md-0 mx-auto" id="ok">
                            <div className="row">
                                <img src={img2} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
                        ...
                        <div className="row mb-lg-5 mx-auto my-xs-0 my-md-0"  id="ok">
                        <div className="row">
                                <img src={img3} alt="alt" className="mx-auto img-fluid"style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
                        ...
                        <div className="row">
                                <img src={img4} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
            ...
            <div className="parent">
              <div className="container mb-lg-1" id="solution">
                <div className="row flex-column-reverse flex-lg-row">
                  <div className="col my-auto">
            <div className="child11 mt-lg-1  mb-lg-5 pb-lg-5">
                <div className="container">
                    <div className="row flex-row flex-nowrap overflow-auto x-scroll-disabled">
                        <div className="col mx-auto my-auto" >
                            <div className="row mb-lg-5 mx-auto" id="ok">
                                <div className="row">
                                <img src={img5} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
                            ...
                            <div className="row">
                                <img src={img6} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
                        ...
                        <div className="row mb-lg-5 mx-auto" id="ok">
                        <div className="row">
                                <img src={img7} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
                        ...
                        <div className="row my-3 mx-auto" id="ok">
                        <div className="row">
                                <img src={img8} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3">
        ...
        <h5 style={{color:"white",fontWeight:"lighter"}}><span style={{color: "#a25edc",fontWeight: "normal"}}>Discern between real and fake</span></h5>
        <h1 className="py-3 mx-auto" id="h22" style={{marginTop:"2%",color:"white"}}>
        The Blockchain Solution</h1><h6 style={{color:"white",fontWeight:"lighter"}} className="mr-3">
            <span style={{color: "white",fontWeight: "normal"}}>Autify leverages blockchain technology to offer the solution to this problem. We want to enable users to digitally authenticate what they’re buying in real-time with a simple scan on their smartphone. The completely unique smart tag (RFID/NFC/IoT) protects the brand identity and detects clones instantly and proves the integrity of the product via immutable digital records that can be accessed and verified from anywhere.</span></h6>
            <div className="my-5"><a href="#contact" data-target="#contact" className="button_info my-3">Get in Touch</a></div>
        </div>
            ...
            <div className="parent mb-5 pb-5">
                ...
                <div className="container">
                 ...
                 <h5 style={{color:"white",fontWeight:"lighter"}}><span style={{color: "#a25edc",fontWeight: "normal"}} >Online shopping made safe</span></h5>
                 <h1 className="py-3 mx-auto" id="h22" style={{marginTop:"2%",color:"white",WebkitBackgroundClip: "text",backgroundClip: "text"}}>
                 Securing the <br/> E-commerce Experience</h1><h6 style={{color:"white",fontWeight:"lighter"}} className="mr-3">
                     <span style={{color: "white",fontWeight: "normal"}}>While retail has shifted online, e-commerce has become the hotbed of knock-off products. Limited means of verification makes this illicit network hard to bring down. We are developing an expansive digital ledger of brands through inviolable blockchain technology. Our dependable protocol can be connected to popular marketplace APIs, which will make it impossible for counterfeiters to list their goods on the platform.</span></h6>
                     <div className="my-5"><a  className="button_info my-3" href="#contact" data-target="#contact">Get in Touch</a></div>
                 </div>
                  ...
                  <div className="container">
                      <div className="row flex-row flex-nowrap overflow-auto x-scroll-disabled">
                          <div className="col mx-auto my-auto" >
                              <div className="row mb-lg-5 mx-auto" id="ok">
                                  <div className="row">
                                  <img src={img13} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                  </div>
                                  <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                      <h4 className="mx-auto my-3">
                              ...
                              <div className="row my-lg-3 my-xs-0 my-md-0 mx-auto" id="ok">
                              <div className="row">
                                  <img src={img14} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                  </div>
                                  <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                      <h4 className="mx-auto my-3">
                          ...
                          <div className="row mb-lg-5 mx-auto my-xs-0 my-md-0"  id="ok">
                          <div className="row">
                                  <img src={img15} alt="alt" className="mx-auto img-fluid"style={{width:"120px"}} id="neu_img"></img>
                                  </div>
                                  <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                      <h4 className="mx-auto my-3">
                          ...
                          <div className="row my-3 mx-auto" id="ok">
                          <div className="row">
                                  <img src={img16} alt="alt" className="mx-auto img-fluid" style={{width:"120px"}} id="neu_img"></img>
                                  </div>
                                  <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                      <h4 className="mx-auto my-3">
            ...
            <div className="container mb-lg-5 pb-lg-5 pt-lg-0 mt-xs-5 pt-xs-5">
           
              <h5 style={{color: "#a25edc",fontWeight: "normal"}}>Creating a digital identity</h5>
            
              <h1 className="my-3 mr-auto" id="h22" style={{marginTop:"2%",color:"white"}}>What We Offer</h1>
              <div className="row mb-lg-5 pb-lg-5 flex-row flex-nowrap overflow-auto x-scroll-disabled row-xs-12" id="phone3">
            <div className="col my-3 mx-auto"  style={{placeContent:"center",placeItems:"center"}} >
                        <div className="row" id="offer_card">
                                <img src={img9} alt="alt" className="mx-auto img-fluid" style={{width:"140px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}} >
                                    <h4 className="mx-auto my-3" style={{textAlign:"center"}}>
                                    Distinct Product Identity
                                    </h4>
                                    <p className="my-lg-4" id="ptag" style={{textAlign:"center"}}>Partner brands are able to tag their products with a secure permanently linked mark.</p> 
                                </div>
    
                            </div>
                            <div className="col my-3 mx-auto" style={{placeContent:"center",placeItems:"center"}} >
                        <div className="row" id="offer_card" >
                                <img src={img10} alt="alt" className="mx-auto img-fluid" style={{width:"140px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3" style={{textAlign:"center"}}>
                                    Unique Authentication System 
                                    
                                    </h4><p style={{textAlign:"center"}}> We make use of artificial intelligence, image recognition, bio-inspired technology and blockchain novelty.  </p>
                                </div>
    
                            </div>
                            <div className="col my-3 mx-auto"  style={{placeContent:"center",placeItems:"center"}}  id="offer_card">
                        <div className="row" id="offer_card">
                                <img src={img11} alt="alt" className="mx-auto img-fluid" style={{width:"140px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3" style={{textAlign:"center"}}>
                                    Instant Clone Identification
                                  
                                    </h4>  <p className="my-lg-4" style={{textAlign:"center"}}>Slightest anomaly in the scanning process marks the product as inauthentic.</p>
                                </div>
    
                            </div>
                            <div className="col my-3 mx-auto" style={{placeContent:"center",placeItems:"center"}} >
                        <div className="row" id="offer_card">
                                <img src={img12} alt="alt" className="mx-auto img-fluid" style={{width:"140px"}} id="neu_img"></img>
                                </div>
                                <div className="row mx-3" style={{color:"white",alignSelf:"center",alignItems:"center"}}>
                                    <h4 className="mx-auto my-3" style={{textAlign:"center"}}>
                                    ...
                                    All data pertaining to the product can be accessed at anytime and cannot be altered or destroyed
                                    </p>
                                </div>
           ...
           <h2 className="my-3 mr-auto" id="h22" style={{marginTop:"2%",color:"white"}}>Industries we're offering </h2>
           <div className="row mb-lg-5 pb-lg-5 flex-row flex-nowrap overflow-auto x-scroll-disabled row-xs-12" id="phone" ref={this.navRef}>
           <div className="col my-3 mx-auto"  style={{placeContent:"center",placeItems:"center"}}  id="offer_card">
                         <div className="row mx-1" id="offer_card" style={{width:"245px"}}>
                             <img src={img19} alt="alt" className="img-fluid"  id="neu_img"></img>
                             </div>
                         ...
                         <div className="col my-3 mx-auto"  style={{placeContent:"center",placeItems:"center"}}  id="offer_card">
                         <div className="row mx-1" id="offer_card" style={{width:"245px"}}>
                             <img src={img23} alt="alt" className="img-fluid"  id="neu_img"></img>
                             </div>
                         ...
                         <div className="col my-3 mx-auto"  style={{placeContent:"center",placeItems:"center"}}  id="offer_card">
                         <div className="row mx-1" id="offer_card" style={{width:"245px"}}>
                             <img src={img24} alt="alt" className="img-fluid"  id="neu_img"></img>
                             </div>
           ...
           <div className="col my-3 mx-auto" style={{placeContent:"center",placeItems:"center"}} >
                         <div className="row mx-1" id="offer_card" style={{width:"245px"}}>
                             <img src={img22} alt="alt" className="img-fluid"  id="neu_img"></img>
                             </div>
                         ...
                         <div className="col my-3 mx-auto" style={{placeContent:"center",placeItems:"center"}} >
                         <div className="row mx-1" id="offer_card" style={{width:"245px"}}>
                             <img src={img20} alt="alt" className="img-fluid"  id="neu_img"></img>
                             </div>
         ...
         <div className="col my-3 mx-auto"  style={{placeContent:"center",placeItems:"center"}} >
                     <div className="row mx-1" id="offer_card" style={{width:"245px"}}>
                             <img src={img17} alt="alt" className="img-fluid" id="neu_img"></img>
                             </div>
                         ...
                         <div className="mt-5 mx-auto" id="#button_toggler"style={{paddingLeft:"33vw"}}>
